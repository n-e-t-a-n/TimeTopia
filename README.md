...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `n-e-t-a-n`, `TimeTopia`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
See the [open issues](https://github.com/n-e-t-a-n/TimeTopia/issues) for a full list of proposed features (and known issues).
...
[license-shield]: https://img.shields.io/github/license/n-e-t-a-n/TimeTopia.svg?style=for-the-badge
